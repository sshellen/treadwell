...
class CaloriesTable extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div>
        ...
        <section>
                  ...
                  <caption>
                    <div className="caption">
                      <span className="description">
                        {" "}
                        <span className="visuallyHidden"> Calories for </span>
          ...
          <div className="nextLink">
            <Link to="/calories">See graphs</Link>
          </div>
        </section>
        ...
        <section>
          <div className="buttonRow">
            ...
            <button
              className="orangeButton"
              onClick={e => this.handleButtonRow(e, "/activityTable")}
            >
              ACTIVITY
            </button>
          </div>
